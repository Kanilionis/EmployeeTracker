...
SELECT employee.first_name, employee.last_name, roles.title, roles.salary, department.dept_id, department.name
FROM employee
...
-- SELECT employee.first_name, employee.last_name, employee.role_id, employee.department_id, department.id, department.name
-- FROM roles
